  ...
  <header id="header">
	...
	<section id="main" class="container">
		<header>
			...
			<p>"How can I join Tau Beta Pi?"</p>
        ...
        <section>
            ...
            <li class="node">
              <span class="node-title">
                <a href="javascript:void(0)">Current Resumé:</a>
              </span>
              <div class="node-contents">
                A copy of your resumé is required in your candidate packet. In addition, a PDF version emailed to <a href="mailto:tbp@ucsd.edu">tbp@ucsd.edu</a> is also required. In the email subject line, please include your name, major, and graduation year. Please also submit your resumé to the Jacobs School of Engineering <a href="https://soeadm.ucsd.edu/Resume/Student">database</a>. 
              </div>
            </li>

            <li class="node">
              <span class="node-title">
                <a href="javascript:void(0)">Two Faculty Ratings:</a>
              </span>
              <div class="node-contents">
                Have two professors who know you or whose class you have taken complete the <a href="resources/Faculty_Rating_Form.pdf">Faculty Rating Form</a>. One of those professors must be from the Jacobs School of Engineering. Return the form in a sealed, signed, and dated envelope. 
              </div>
            </li>

            <li class="node">
              <span class="node-title">
                <a href="javascript:void(0)">Academic Honesty Statement:</a>
              </span>
              <div class="node-contents">
                A hand written statement verifying your compliance with UCSD Policy on Integrity of Scholarship, a copy of which can be downloaded <a href="resources/Academic_Honesty_Statement.pdf">here</a>. Below the statement, please print and sign your name. 
              </div>
            </li>

            <li class="node" id="last-node">
              <span class="node-title">
                <a href="javascript:void(0)">Class Checklist:</a>
              </span>
              <div class="node-contents">
				...
				<section>
					...
					<p>We require eligible initiates to fill out <a href="resources/Initiates_Points.pdf">a point verification form</a> over the course of their Initiation Cycle.
						<ul>
							...
							<li>3 points must be from Outreach/Community Service events</li>
							<li>6 points can be from any of the three categories listed</li>
						</ul>
						Points are usually given at a rate of 1 pt/hr at each event, and typically require a signature from a TBP officer as witness of your attendance. <b>The point verification form must be turned in on the day of Initiation. </b>
					</p>
				</section>
			</section>
			<section class="features-row">
